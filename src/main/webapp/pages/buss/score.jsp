...
<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 450px; height: 400px;"
        ...
        <table cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="easyui-textbox" readonly="readonly" required="true" type="text" name="dormname"
                           id="dormname"></input>
                    <a href="#" class="easyui-linkbutton" iconCls="icon-search"
                       onclick="openWin('dormdg','宿舍信息');">选择</a>
            ...
            <tr>
                <td>打分日期:</td>
                <td><input class="easyui-datebox" editable="false" type="text" id="scoredate" name="scoredate"></input>
                </td>
            </tr>
        </table>
    </form>
...
<div id="dormdg" class="easyui-dialog" title="数据" style="width: 350px; height: 450px; top: 80px;"
...
<div id="dlgClass-buttons">
    <a href="#" class="easyui-linkbutton  save" onclick="afterSelect('dormtable','dormdg','dormid','dormname')"
       iconCls="icon-ok">确定</a>
    <a href="#" class="easyui-linkbutton cancel" onclick="javascript:$('#dormdg').dialog('close')"
       iconCls="icon-cancel">取消</a>
</div>
<script type="text/javascript">
    ...
    function doSearch() {
        var queryCondition = {
            'paramDorm': $('#paramDorm').val(),
            'startDate': $('#paramStart').val(),
            'endDate': $('#paramEnd').val()
        };
