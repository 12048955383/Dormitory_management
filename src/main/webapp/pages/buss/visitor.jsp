	...
	<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 480px; height: 450px;" closed="true" buttons="#dlg-buttons">
		<form method="post" id="fm">
			<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>进入时间:</td>
	    			<td><input class="easyui-datetimebox" id="starttime" required="true" missingMessage="进入时间必须填写" editable="false" type="text" name="starttime"  ></input></td>
	    		</tr>
	    		<tr>
	    			<td>离开时间:</td>
	    			<td><input class="easyui-datetimebox" id="endtime"  required="true" missingMessage="离开时间必须填写"  editable="false"  type="text" name="endtime" ></input></td>
	    		</tr>
