...
<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 350px; height: 200px;"
    ...
    <form method="post" id="fm">
        <table cellpadding="5">
            ...
            <tr>
                <td>班级名称:</td>
                <td><input class="easyui-textbox" type="text" name="classname" maxlength="30" required="true"
                           missingMessage="名称必须填写"></input></td>
            </tr>
            <tr>
                <td>辅导员:</td>
                <td><input class="easyui-textbox" required="true" maxlength="10" type="text" name="teachername"
                           missingMessage="辅导员必须填写"></input></td>
            </tr>
        </table>
    </form>
</div>
...
<script type="text/javascript">
    ...
    function doSearch() {
        var queryCondition = {
            'classname': $('#paramClass').val().trim(),
            'teachername': $('#paramTeacher').val().trim()
        };
